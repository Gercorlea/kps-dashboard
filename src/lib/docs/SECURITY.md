...
`RESEND_API_KEY`, `AI_GATEWAY_API_KEY`, seed del superadmin: solo en
`.env.local` / variables de Vercel. Nunca en el cliente ni en el repo. Los
errores de API nunca filtran stack traces (`handleApiError`).
